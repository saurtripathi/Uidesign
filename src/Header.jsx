...
export default function Header({ toggle, on }) {
    
    return (
        <>
            <header>
                <a href='#' className='logo' >Company</a>
                {!on && <svg onClick={toggle} className="open" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 32 32">
